...
task("withdraw", "returns total donations amount of the account")
  .addParam("account" , "Reciepient")
  ...
  .setAction(async (taskArgs) => {
    ...
    const tx = await CharityContract.withdraw(taskArgs.amount, taskArgs.account);
